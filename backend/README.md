...
## Project Structure
    ...
    ├── tst_daniel_figma_im_22901  # Django project configurations
...
1. Clone this repo and `cd tst_daniel_figma_im_22901`
...
2. Clone this repo and `cd tst_daniel_figma_im_22901`
